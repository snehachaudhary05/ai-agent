          ...
          data.items.map(async item => {
            ...
            try {
              ...
              const clothingQueryOverrides = {
                ...
                'kurti':            'women kurti indian ethnic kurta fashion model',
                'kurtis':           'women kurti indian ethnic kurta fashion model',
                ...
                'palazzo suit':     'palazzo suit indian ethnic fashion woman',
                'indo western':     'indo western fusion outfit woman fashion',
                'indo-western':     'indo western fusion outfit woman fashion',
                // Indian Ethnic - Men
                'sherwani':         'sherwani men indian ethnic wedding fashion',
                'kurta':            'kurta men indian ethnic wear fashion',
                'nehru jacket':     'nehru jacket men indian ethnic fashion',
                // Western - Women
                'skirts':           'women skirt fashion model stylish outfit',
                'skirt':            'women skirt fashion model stylish outfit',
                'ruffle skirt':     'women ruffle skirt fashion model stylish',
                'mini skirt':       'women mini skirt fashion model stylish',
                'maxi skirt':       'women maxi skirt fashion model stylish',
                'tops':             'women top blouse fashion model stylish outfit',
                'top':              'women top blouse fashion model stylish outfit',
                'peplum':           'women peplum top fashion model stylish',
                'crop top':         'women crop top fashion model stylish',
                'dresses':          'women dress fashion model stylish elegant',
                'dress':            'women dress fashion model stylish elegant',
                'maxi dress':       'women maxi dress fashion model elegant',
                'mini dress':       'women mini dress fashion model stylish',
                'jeans':            'women jeans denim fashion model stylish',
                'denim':            'women denim jeans fashion model stylish',
                'palazzo':          'women palazzo pants wide leg fashion model',
                'trousers':         'women trousers formal pants fashion model',
                'shorts':           'women shorts casual fashion model stylish',
                'co-ord':           'women co-ord matching set fashion model stylish',
                'coord':            'women co-ord matching set fashion model stylish',
                'co ord':           'women co-ord matching set fashion model stylish',
                'jacket':           'women jacket fashion model stylish outerwear',
                'jackets':          'women jacket fashion model stylish outerwear',
                'blazer':           'women blazer fashion model stylish formal',
                'sweater':          'women sweater knitwear fashion model cozy',
                'sweaters':         'women sweater knitwear fashion model cozy',
                'hoodie':           'women hoodie casual fashion model stylish',
                'activewear':       'women activewear sportswear gym fashion model',
                'swimwear':         'women swimwear beach fashion model stylish',
                // Western - Men
                'shirts':           'men shirt fashion model formal casual',
                'shirt':            'men shirt fashion model formal casual',
                't-shirt':          'men t-shirt casual fashion model streetwear',
                't-shirts':         'men t-shirt casual fashion model streetwear',
                'men jeans':        'men jeans denim fashion model stylish',
                'formal wear':      'men formal suit fashion model professional',
                // Accessories
                'handbags':         'women handbag purse fashion stylish leather',
                'handbag':          'women handbag purse fashion stylish leather',
                'bags':             'women bag purse fashion stylish collection',
                'bag':              'women bag purse fashion stylish',
                'clutch':           'women clutch bag evening fashion stylish',
                'necklace':         'women necklace jewelry fashion gold silver',
                'earrings':         'women earrings jewelry fashion gold silver',
                'bangles':          'bangles jewelry indian fashion gold',
                'jewelry':          'women jewelry fashion gold silver elegant',
                'watches':          'watch wristwatch fashion luxury stylish',
                'watch':            'watch wristwatch fashion luxury stylish',
                'sunglasses':       'sunglasses eyewear fashion model trendy',
                // Footwear
                'heels':            'women heels shoes fashion model elegant',
                'sandals':          'women sandals shoes fashion summer stylish',
                'boots':            'women boots shoes fashion model stylish',
                'sneakers':         'sneakers shoes fashion model casual sporty',
                'footwear':         'women footwear shoes fashion collection stylish',
                'shoes':            'women shoes fashion model stylish collection',
              }
